...
.revenue-drivers > div > div {
  ...
  align-items: center;
  padding: 12px 16px;
  /* use a right-fade gradient so it doesn't look abruptly cut on small screens */
  background: linear-gradient(90deg, rgba(102,126,234,0.08) 0%, rgba(102,126,234,0.04) 72%, rgba(102,126,234,0) 100%);
  border-radius: 8px;
...
.uae-dirham-symbol {
  ...
  vertical-align: -0.1em; /* Negative value to lower the symbol */
  width: 1em;
  height: 1em;
  margin-right: 0.2em;
  fill: currentColor;

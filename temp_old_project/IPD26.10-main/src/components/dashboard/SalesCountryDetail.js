    ...
    return (
      <div style={{
        ...
        {columnOrder.map((column, index) => {
          const periodColor = getPeriodColor(column);
          ...
          return (
            <button
              ...
              style={{
                padding: '8px 12px',
                border: isSelected ? `2px solid ${periodColor}` : '1px solid #ddd',
                background: isSelected ? periodColor : '#fff',
                ...
                boxShadow: isSelected ? `0 2px 8px ${periodColor}40` : 'none'
              }}
            >

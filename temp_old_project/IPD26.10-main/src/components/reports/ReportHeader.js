...
const ReportHeader = ({ rep, basePeriod, prevPeriod, toProperCase }) => {
  ...
  // Use the actual previous period if available (from columnOrder), otherwise calculate from base period

...
class HCDataService {
  ...
  async getProductGroups() {
    try {
      ...
      console.error('Error fetching HC product groups:', error);
      throw error;
    }
  }
  ...
  async getProductGroupsBySalesRep(salesRep) {
    try {
      ...
      console.error('Error fetching HC product groups by sales rep:', error);
      throw error;
    }
  }
  ...
  async getSalesData(salesRep, productGroup, valueType, year, month) {
    try {
      ...
      console.error('Error fetching HC sales data:', error);
      throw error;
    }
  }
  ...
  async getSalesDataByValueType(salesRep, productGroup, valueType, year, month, dataType = 'Actual') {
    try {
      ...
      console.error('Error fetching HC sales data by value type:', error);
      throw error;
    }
  }
  ...
  async getSalesDataForGroup(groupMembers, productGroup, valueType, year, month, dataType = 'Actual') {
    try {
      ...
      console.error('Error fetching HC sales data for group:', error);
      throw error;
    }
  }
  ...
  async getCustomersBySalesRep(salesRep) {
    try {
      ...
      console.error('Error fetching HC customers by sales rep:', error);
      throw error;
    }
  }
  ...
  async getCustomersForGroup(groupMembers) {
    try {
      ...
      console.error('Error fetching HC customers for group:', error);
      throw error;
    }
  }
  ...
  async getCustomerSalesDataByValueType(salesRep, customer, valueType, year, month, dataType = 'Actual') {
    try {
      ...
      console.error('Error fetching HC customer sales data:', error);
      throw error;
    }
  }
  ...
  async getCustomerSalesDataForGroup(groupMembers, customer, valueType, year, month, dataType = 'Actual') {
    try {
      ...
      console.error('Error fetching HC customer sales data for group:', error);
      throw error;
    }
  }
  ...
  async getProductGroupPricingYears() {
    try {
      ...
      console.error('Error fetching HC product group pricing years:', error);
      throw error;
    }
  }
  ...
  async getProductGroupPricingAverages(year) {
    ...
    try {
      ...
      console.error('Error fetching HC product group pricing averages:', error);
      throw error;
    }
  }
  ...
  async getExcludedProductGroups() {
    try {
      ...
      console.error('Error fetching HC excluded product groups:', error);
      return ['Service Charges', 'Others', 'Other', 'Miscellaneous', 'Service', 'Charges'];
    }
  }
  ...
  async getMaterialPercentage(productGroup) {
    try {
      ...
      console.error('Error fetching HC material percentage:', error);
      throw error;
    }
  }
  ...
  async saveMaterialPercentage(productGroup, percentages, material = '', process = '') {
    try {
      ...
      console.error('Error saving HC material percentage:', error);
      throw error;
    }
  }
  ...
  async deleteMaterialPercentage(productGroup) {
    try {
      ...
      console.error('Error deleting HC material percentage:', error);
      throw error;
    }
  }
  ...
  async getMasterConfig(key) {
    try {
      ...
      console.error('Error fetching HC master config:', error);
      throw error;
    }
  }
  ...
  async setMasterConfig(key, value, description = null) {
    try {
      ...
      console.error('Error setting HC master config:', error);
      throw error;
    }
  }
  ...
  async getYearlyBudget(salesRep, year, valuesType, groupMembers = null) {
    try {
      ...
      console.log(`📊 HC Yearly budget query result for ${salesRep} (${year}, ${valuesType}): ${totalValue}`);
      
      return totalValue;
    } catch (error) {
      console.error('Error fetching HC yearly budget:', error);
      throw error;
    }
  }
}

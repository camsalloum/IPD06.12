  ...
  async getGeographicDistributionData(filters) {
    try {
      ...
      if (includeComparison) {
        ...
        // Use the appropriate query and params based on type
        let previousParams;
        if (isEstimateType) {
          previousParams = [previousYear, monthIntegers];
        } else {

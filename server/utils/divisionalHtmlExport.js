 ...
 * @param {string} params.division - Division code (FP, HC)
...
function generateDivisionalBudgetHtml({
  ...
  // Services Charges Row (if data exists)
  if (servicesChargesData && servicesChargesData.monthlyActual) {
    let scActualCells = '';
    let scActualTotal = 0;
...
<body>
  ...
  <div class="summary-container">
    ...
    <div class="summary-cards">
      ...
      <!-- Amount Card -->
      <div class="summary-card">
        <div class="summary-card-title">${dirhamSvg} Amount</div>
        <div class="summary-card-values">
    ...
    <table>
      ...
      <tfoot>
        ...
        <tr class="actual-amount-total">
          <td>Total Actual Amount ${dirhamSvg}</td>
          ${actualAmountCells}
          <td>${formatAed(actualAmountTotal)}</td>
        </tr>
        <tr class="actual-morm-total">
          <td>Total Actual MoRM ${dirhamSvg}</td>
          ${actualMormCells}
  ...
  <div id="productGroupChartContainer" class="product-group-chart-container">
    ...
    <!-- Amount Table -->
    <div class="product-group-chart-title" style="margin-top: 24px;">${dirhamSvg}<span>Amount Breakdown</span></div>
    ...
    <!-- MoRM Table -->
    <div class="product-group-chart-title" style="margin-top: 24px;">${dirhamSvg}<span>MoRM Breakdown</span></div>
